...
// ─── Deliver card ─────────────────────────────────────────────────────────────
function DeliverCard({ drop, dropCity, customer, phone, earning, emoji, parcel, otp, onOtpChange }: {
  drop: string; dropCity: string; customer: string; phone: string;
    ...
    <View style={[st.card, st.cardGlowPurple]}>
      ...
      <View style={st.otpWrap}>
        <View style={st.otpHeader}>
          ...
          <View style={st.otpBadge}><Text style={st.otpBadgeTxt}>Optional</Text></View>
        </View>
          ...
          {stage === "at_drop" && (
            <>
              <DeliverCard drop={drop} dropCity={dropCity} customer={customer} phone={phone}
                earning={earning} emoji={emoji} parcel={parcel} otp={otp} onOtpChange={setOtp} />

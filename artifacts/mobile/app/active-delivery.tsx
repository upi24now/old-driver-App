...
export default function ActiveDeliveryScreen() {
  ...
  const { activeOrders, activeRide, endRide, orderRemovalReasons, driverUid, addEarningLocally, refreshWallet } = useDriver();
  ...
  // Uses thisOrder (not activeRide) so the OTP belongs to THIS screen's order —
  // activeRide may point to a different order if currentActiveOrderId shifted.
  const expectedOtp = thisOrder?.deliveryOtp;
